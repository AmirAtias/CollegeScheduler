...
public interface FinalsAndMsg { // this interface contain all the finals and Strings msg
	...
	public final int DEFAULT_NEG_VAL=-1;
    ...
    public String COURSE_LIST_EMPTY="course list is empty!";
    public String SELECT_COURSE_ERROR="you didn't choose any course";
    public String SELECT_SHOW_ERROR="you didn't choose any show";
    public String THERE_IS_LECTURE="there is already another lecture";
    public String HOUR_OUCCPIED="this hour is already ouccpied";
